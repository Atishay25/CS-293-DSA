...
public:
  ...
  void updateAVLHeight(TreeNode *currNode, TreeNode *parentNode, TreeNode *grandParentNode);
  void updateHeightDel(TreeNode *currNode, TreeNode *parentNode, TreeNode *grandParentNode);
  int getComparisonCost() { return totalComparisonCost; }
  int getParentChildUpdateCost() { return totalParentChildUpdateCost; }
  TreeNode *successor(TreeNode *currNode);
  TreeNode *minNode(TreeNode *currNode);
  TreeNode *findImbalanceNode(TreeNode *v);
  TreeNode *getLargeHeightNode(TreeNode *v);
  TreeNode *searchNode(int jrnyCode);
  void check(); //mine
  void inOrder(TreeNode *v); //mine
